...
let package = Package(
  name: "GoogleCloudContainerAnalysisV1",
  platforms: [.macOS(.v15)],
  products: [
    .library(name: "GoogleCloudContainerAnalysisV1", targets: ["GoogleCloudContainerAnalysisV1"])
  ],
  dependencies: [
    ...
    localOrRemotePackage(
      url: "https://github.com/googleapis/swift-grafeas-v1",
      path: "generated/swift-grafeas-v1",
      from: "0.3.0"
    ),
    localOrRemotePackage(
  ...
  targets: [
    .target(
      ...
      dependencies: [
        ...
        .product(name: "GoogleGrafeasV1", package: "swift-grafeas-v1"),
